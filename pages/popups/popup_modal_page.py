...
class ModalPopupPage(BasePage):
    ...
    @allure.step("Open Pop-Up modal")
    def open_popup(self):
        self.button.click()


    @allure.step("Check Pop-Up modal is visible")
    ...
    def should_have_popup_default_state(self):
        with allure.step("Check Pop-Up title is 'I am a Pop-Up'"):
            expect(self.popup.locator("#exampleModalLabel")).to_have_text("I am a Pop-Up")
        with allure.step("Check checkbox 'Select me or not' on the Pop-Up"):
        ...
        with allure.step("Check buttons on the Pop-Up"):
            ...
            expect(self.popup.locator(".modal-footer button[type='button']")).to_have_text("Cancel")


    @allure.step("Submit Pop-Up modal with checkbox checked")
